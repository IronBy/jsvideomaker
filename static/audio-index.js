...
//   let effects = getCurrentEffects(currentAudio);
...
// function getCurrentEffects(audio) {
//   return effects
//     .filter(function (effect) {
//       return effect.start <= audio.currentTime && audio.currentTime <= (effect.start + effect.duration)
//     });
// }
...
//   function play(context) {
//     if (opts.audio.paused) {
//       opts.audio.currentTime = opts.startTime;
//       opts.audio.play();
//     }
//   }
